...
(function($) {
  $.fn.bkmenu = function(options) {
    ...
    var init = function(){
      ...
      menu.on('mouseenter.menu', 'li', function(event){
      ...
      menu.on('mousemove.menu',function(){
        menuMouseover = true;
    ...
    menu.itemSelect = function(){
      ...
      aparentLi = menuCurrent.parent();
      aparentLi.parent().children('li').not(aparentLi).removeClass(settings.classSelected + " hascontent");
      aparentLi.addClass(settings.classSelected + " hascontent");
